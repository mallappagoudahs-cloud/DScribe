...
translations = {
  "en": {
    ...
    "add_drug": "\u2795 Add Drug",
    "clear_form": "\U0001f5d1 Clear",
    "send_alert": "\U0001f514 Send Alert",
  ...
  "hi": {
    ...
    "add_drug": "\u2795 \u0926\u0935\u093e \u091c\u094b\u0921\u093c\u0947\u0902",
    "clear_form": "\U0001f5d1 \u0939\u091f\u093e\u090f\u0901",
    "send_alert": "\U0001f514 \u0928\u0930\u094d\u0938 \u0915\u094b \u092c\u0924\u093e\u090f\u0902",
  ...
  "kn": {
    ...
    "add_drug": "\u2795 \u0c94\u0cb7\u0ca7 \u0cb8\u0cc7\u0cb0\u0cbf\u0cb8\u0cbf",
    "clear_form": "\U0001f5d1 \u0ca4\u0cc6\u0cb0\u0cb5\u0cc1\u0c97\u0cca\u0cb3\u0cbf\u0cb8\u0cbf",
    "send_alert": "\U0001f514 \u0c85\u0cb2\u0cb0\u0ccd\u0c9f\u0ccd \u0c95\u0cb3\u0cc1\u0cb9\u0cbf\u0cb8\u0cbf",
...
# Read file with error replacement to get a workable string
with open("static/index.html", "rb") as f:
    raw = f.read()

text = raw.decode("utf-8", errors="replace")

# Find TRANSLATIONS block bounds
start_marker = "const TRANSLATIONS ="
end_marker = "let currentLang = 'en';"
...
if start_idx == -1 or end_idx == -1:
    ...
    # Build clean JS TRANSLATIONS object
    js_obj = json.dumps(translations, indent=6, ensure_ascii=False)
    # Convert JSON format to JS (unquote string keys)
    js_obj = re.sub(r'"([a-zA-Z_]+)": ', r'\1: ', js_obj)
    # Replace double quotes with single quotes for string values
    js_obj = js_obj.replace('"', "'")
    new_block = "    const TRANSLATIONS = " + js_obj + ";\n    "
    ...
    with open("static/index.html", "w", encoding="utf-8") as f:
        f.write(new_text)
    print("SUCCESS: TRANSLATIONS block replaced cleanly")
    ...
    try:
        verify.decode("utf-8")
        print("VERIFIED: File is valid UTF-8 now!")
